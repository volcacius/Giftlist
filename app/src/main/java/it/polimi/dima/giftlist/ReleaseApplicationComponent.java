 ...
 */
@Singleton
@Component(modules = {ApplicationModule.class, ReleaseCurrencyModule.class, ReleaseEtsyModule.class, ReleaseEbayModule.class, CurrencyModule.class, EtsyModule.class, EbayModule.class, DbModule.class})
