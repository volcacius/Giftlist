...
import it.polimi.dima.giftlist.util.AndroidComponentUtil;
import it.polimi.dima.giftlist.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        GiftlistApplication.get(this).getComponent().inject(this);
    }
