 ...
 */
@Singleton
@Component(modules = {ApplicationModule.class, DebugCurrencyModule.class, DebugEtsyModule.class, DebugEbayModule.class, CurrencyModule.class, EtsyModule.class, EbayModule.class, DbModule.class})
